...
$routes->get('cron/processPending', 'CronController::processPending');
...
$routes->group('siswa', ['filter' => ['role:siswa', 'license']], function($routes) {
    ...
    $routes->get('riwayat-kehadiran', 'StudentController::riwayatKehadiran');
    $routes->get('riwayat-izin', 'StudentController::riwayatIzin');
});
...
$routes->group('walikelas', ['namespace' => 'App\Controllers\Walas', 'filter' => ['role:walikelas', 'license']], function($routes) {
    ...
    $routes->post('profil/password/update', 'Profil::updatePassword');
});
...
$routes->group('admin', [
    ...
    // Mapping Kelas
    $routes->get('mapping', 'KelasMapping::index');
    $routes->get('mapping/create', 'KelasMapping::create');
    $routes->post('mapping/store', 'KelasMapping::store');
    $routes->get('mapping/edit/(:num)', 'KelasMapping::edit/$1');
    $routes->post('mapping/update/(:num)', 'KelasMapping::update/$1');
    $routes->post('mapping/delete/(:num)', 'KelasMapping::delete/$1');

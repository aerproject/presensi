...
<div class="container-fluid px-0">
    ...
    <div class="student-info">
        ...
        <div class="student-detail">
            ...
            <?= esc($namaKelas ?? ($anak['nama_kelas'] ?? '-')) ?>

            &nbsp;•&nbsp;

            <?= esc($namaJurusan ?? ($anak['nama_jurusan'] ?? '-')) ?>
    ...
    <div class="filter-card">
        ...
        <form
            method="get"
            action="<?= site_url('ortu/riwayat-izin') ?>">

<?php
// C:\wamp\www\absensiku\app\Views\beranda\alpha.php
?>

<?= $this->extend('layouts/main') ?>

<?= $this->section('content') ?>
<h2 class="mb-4 mt-5 text-center">🚫 Data Siswa Alpha</h2>
...
<div class="table-responsive">
    <table class="table table-sm table-bordered table-striped shadow-sm align-middle">
        ...
        <tbody>
            <?php if (!empty($alpha)): ?>
                <?php foreach ($alpha as $index => $row): ?>
                    <tr>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="5" class="text-center">Tidak ada data siswa alpha.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
